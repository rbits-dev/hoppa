...
export default class FrogController implements Creature {
    ...
    private name: string;
    private myMoveTime = Phaser.Math.Between(2000,5000);
    ...
    constructor(
     ...
     //   this.velocityX = velocityX;
        ...
        this.velocityX += Phaser.Math.FloatBetween(0.0, 0.33);
    ...
    private moveRightOnEnter() {
        this.moveTime = 0;
        this.myMoveTime = Phaser.Math.Between(2000,6000);
    }
