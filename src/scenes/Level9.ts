...
export default class Level9 extends BaseScene {
    ...
    preload() {
        ...
        this.load.image('cave', 'assets/cave.webp');
        this.load.image('items', 'assets/items.webp');
        
        SceneFactory.preload(this);

        this.load.tilemapTiledJSON('tilemap10', 'assets/map10.json');
    }
    ...
    create() {
        ...
        AlignmentHelper.createAligned(this, totalWidth, hei,"cave", 0.375,s); //mountain

        this.map = this.make.tilemap({ key: 'tilemap10', tileWidth: 64, tileHeight: 64 });
